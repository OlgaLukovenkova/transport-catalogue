...
namespace graph {
    ...
    public:
        ...
        /* for serialization */ 
        template <typename RoutesInternalDataType>
        explicit Router(const Graph& graph, RoutesInternalDataType&& data)
            : graph_(graph)
            , routes_internal_data_(std::forward<RoutesInternalDataType>(data))
